...
GCC_PATH="C:/INSTALL/MCU/GCC-ARM-NONE-EABI-6-2017-Q2-UPDATE-WIN32/BIN
ifdef GCC_PATH
...
#######################################
# link script
LDSCRIPT = STM32F102C8Tx_FLASH.ld
...
flash: $(BUILD_DIR)/$(TARGET).elf
	"C:/INSTALL/MCU/OPENOCD-20231002-0.12.0/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	"C:/INSTALL/MCU/OPENOCD-20231002-0.12.0/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "init; reset halt; stm32f1x mass_erase 0; exit"
